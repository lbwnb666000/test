...
<script setup>
	...
	const articelDatas = ref([
		...
		{id:3,img:'../../public/vite.svg',userName:'西安颇为',timeFrom:'34分钟前',title:"咋写啊大",content:"的疯狂工人老人家幸亏我浪费法国加入手卡怎么了两方面矿山巨头十五分今日让伤口代码数据库",favour:10,statu:true,number:431,store:false,comented:false,share:false},
		{id:4,img:'../../public/vite.svg',userName:'为其揭幕亏了',timeFrom:'99分钟前',title:"Wald沟通工具啊单位提供",content:"13534764856753534636",favour:403,nstatu:true,number:431,store:false,comented:false,share:false},
	])
